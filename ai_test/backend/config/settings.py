...
FEISHU_CASESET_PROJECT_KEY = os.getenv('FEISHU_CASESET_PROJECT_KEY', '658ea728fbaa1f76e5a39e2b')

# ==============飞书项目 Open API 插件配置==============
FEISHU_PROJECT_PLUGIN_ID = os.getenv('FEISHU_PROJECT_PLUGIN_ID', '')
FEISHU_PROJECT_PLUGIN_SECRET = os.getenv('FEISHU_PROJECT_PLUGIN_SECRET', '')
FEISHU_PROJECT_USER_KEY = os.getenv('FEISHU_PROJECT_USER_KEY', '')
