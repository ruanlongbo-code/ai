  ...
  actions: {
    ...
    getPageInfo(route) {
      const routeMap = {
        ...
        '/function-test/ai-optimize': { title: 'AI优化需求', icon: 'MagicStick' },
        '/function-test/requirement': { title: 'AI生成用例', icon: 'Document' },
        '/function-test/case': { title: '功能用例集', icon: 'DocumentChecked' },
