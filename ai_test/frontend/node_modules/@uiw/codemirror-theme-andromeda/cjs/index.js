...
exports.defaultSettingsAndromeda = exports.andromedaInit = exports.andromedaDarkStyle = exports.andromeda = void 0;
...
var andromedaDarkStyle = exports.andromedaDarkStyle = [{
...
var andromedaInit = exports.andromedaInit = function andromedaInit(options) {
  ...
  return (0, _codemirrorThemes.createTheme)({
    ...
    styles: [].concat(andromedaDarkStyle, (0, _toConsumableArray2["default"])(styles))
  });
};
