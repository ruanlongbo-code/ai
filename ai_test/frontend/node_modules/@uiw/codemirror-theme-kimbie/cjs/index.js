...
exports.kimbieInit = exports.kimbieDarkStyle = exports.kimbie = exports.defaultSettingsKimbie = void 0;
...
var kimbieDarkStyle = exports.kimbieDarkStyle = [{
...
var kimbieInit = exports.kimbieInit = function kimbieInit(options) {
  ...
  return (0, _codemirrorThemes.createTheme)({
    ...
    styles: [].concat(kimbieDarkStyle, (0, _toConsumableArray2["default"])(styles))
  });
};
