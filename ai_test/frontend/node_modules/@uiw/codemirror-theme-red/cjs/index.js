...
exports.redInit = exports.redDarkStyle = exports.red = exports.defaultSettingsRed = void 0;
...
var redDarkStyle = exports.redDarkStyle = [{
...
var redInit = exports.redInit = function redInit(options) {
  ...
  return (0, _codemirrorThemes.createTheme)({
    ...
    styles: [].concat(redDarkStyle, (0, _toConsumableArray2["default"])(styles))
  });
};
