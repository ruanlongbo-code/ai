...
exports.defaultSettingsAtomone = exports.atomoneInit = exports.atomoneDarkStyle = exports.atomone = void 0;
...
var atomoneDarkStyle = exports.atomoneDarkStyle = [{
...
var atomoneInit = exports.atomoneInit = function atomoneInit(options) {
  ...
  return (0, _codemirrorThemes.createTheme)({
    ...
    styles: [].concat(atomoneDarkStyle, (0, _toConsumableArray2["default"])(styles))
  });
};
