...
exports.defaultSettingsAbyss = exports.abyssInit = exports.abyssDarkStyle = exports.abyss = void 0;
...
var abyssDarkStyle = exports.abyssDarkStyle = [{
...
var abyssInit = exports.abyssInit = function abyssInit(options) {
  ...
  return (0, _codemirrorThemes.createTheme)({
    ...
    styles: [].concat(abyssDarkStyle, (0, _toConsumableArray2["default"])(styles))
  });
};
