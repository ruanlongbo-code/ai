...
exports.defaultSettingsCopilot = exports.copilotInit = exports.copilotDarkStyle = exports.copilot = void 0;
...
var copilotDarkStyle = exports.copilotDarkStyle = [{
...
var copilotInit = exports.copilotInit = function copilotInit(options) {
  ...
  return (0, _codemirrorThemes.createTheme)({
    ...
    styles: [].concat(copilotDarkStyle, (0, _toConsumableArray2["default"])(styles))
  });
};
