...
exports.monokaiDimmedInit = exports.monokaiDimmedDarkStyle = exports.monokaiDimmed = exports.defaultSettingsMonokaiDimmed = void 0;
...
var monokaiDimmedDarkStyle = exports.monokaiDimmedDarkStyle = [{
...
var monokaiDimmedInit = exports.monokaiDimmedInit = function monokaiDimmedInit(options) {
  ...
  return (0, _codemirrorThemes.createTheme)({
    ...
    styles: [].concat(monokaiDimmedDarkStyle, (0, _toConsumableArray2["default"])(styles))
  });
};
