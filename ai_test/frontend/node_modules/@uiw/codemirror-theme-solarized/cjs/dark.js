...
exports.solarizedDarkStyle = exports.solarizedDarkInit = exports.solarizedDark = exports.defaultSettingsSolarizedDark = void 0;
...
var defaultSettingsSolarizedDark = exports.defaultSettingsSolarizedDark = {
  ...
  selectionMatch: _darkColor.config.selection,
...
var solarizedDarkStyle = exports.solarizedDarkStyle = [{
  ...
  color: _darkColor.config.number
}, {
...
var solarizedDarkInit = exports.solarizedDarkInit = function solarizedDarkInit(options) {
  var _ref = options || {},
  ...
  return (0, _codemirrorThemes.createTheme)({
    ...
    styles: [].concat(solarizedDarkStyle, (0, _toConsumableArray2["default"])(styles))
  });
};
var solarizedDark = exports.solarizedDark = solarizedDarkInit();